...
<div class="container">
    ...
    <table id="usertable" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
          ...
          <tr>
          <td><a href="{{route('edit_expense',$expense->id)}}" >{{$expense->expense_category}}</a></td>
    ...
    <button style="align:right" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Addexpense">Add Expense</button>
...
<div class="modal fade" id="Addexpense" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{route('submit_expense')}}" method="POST">  
          {{csrf_field()}}
          <div class="mb-3">
