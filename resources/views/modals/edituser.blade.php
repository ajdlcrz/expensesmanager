...
<div class="container">
        ...
        <form action="{{route('update_user',$users->id)}}" method="POST">  
          ...
          <div class="mb-3">
            ...
            <input type="email" class="form-control" name="userEmail" value="{{$users->user_email}}" required>
          </div>
          <div class="mb-3">
          ...
          <a type="button" class="btn btn-danger" href="{{route('delete_user',$users->id)}}">Delete</a>
