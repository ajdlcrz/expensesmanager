...
<div class="container">
    ...
    <table id="roletable" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
          ...
          <tr>
                <td><a href="{{route('edit_role',$roles->id)}}" >{{$roles->role_name}}</a></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('submit_role')}}" method="POST">
          {{csrf_field()}}
          <div class="mb-3">
            <label for="displaynameR" class="form-label">Display Name</label>
            <input type="text" class="form-control" name="displaynameR" required>
          </div>
          <div class="mb-3">
            <label for="descrole" class="form-label">Description</label>
            <input type="text" class="form-control" name="descrole" required>
          </div>
